...
var Expand = function (_a) {
    ...
    return (React.createElement("section", { "data-testid": "expand", className: cn("expand", (_b = {},
        ...
        React.createElement("div", { className: cn("expand__content", (_e = {},
...
var Checkbox = function (_a) {
    ...
    return (React.createElement("label", { className: cn("checkbox", className, (_b = {},
            _b["checkbox_active"] = checked,
            _b["checkbox_disabled"] = disabled,
            _b)) },
        React.createElement(formik.Field, { type: "checkbox", name: name, className: "checkbox__input" }),
        React.createElement("span", { className: "checkbox__indicator" }),
        React.createElement("div", { className: "checkbox__info" },
            React.createElement("span", { className: "checkbox__info-title" }, title)),
        errors && touched && (React.createElement(formik.ErrorMessage, { name: name, component: errComponent || "div", className: cn("checkbox-warning", errClassName) }))));
};
...
var Reminder = function (_a) {
    ...
    return (React.createElement("div", { className: cn("notification", (_b = {}, _b["warning"] = warning, _b), className) },
...
var FormField = /** @class */ (function (_super) {
    ...
    FormField.prototype.render = function () {
        ...
        switch (type) {
            case "password":
                return (React.createElement("div", { className: cn("form-field-wrapper", "password-input", className) },
                    React.createElement(formik.Field, { type: this.state.show ? "password" : "text", name: name, placeholder: " ", className: cn("form-field", {
                            "form-field_error": errors && touched && errors[name] && touched[name]
                        }, className), onBlur: onBlur, "data-testid": "input" }),
                    React.createElement("img", { src: !this.state.show ? img$N : img$M, alt: "eye", className: "password-input__eye", onClick: handleEyeClick }),
                    React.createElement("label", { className: "form-field-label", htmlFor: name }, placeholder),
                    errors && touched && (React.createElement(formik.ErrorMessage, { name: name, component: errComponent || "div", className: cn("form-field-error-message", errClassName) }))));
            default:
                return (React.createElement("div", { className: cn("form-field-wrapper", className) },
...
var CommonButton = function (_a) {
    ...
    return (React.createElement("button", { "data-testid": "common-button", className: cn("common-button", className, (_b = {},
        ...
        (image || round) && (React.createElement("div", { className: "common-button_image-container" }, typeof image === "string" ? (React.createElement("img", { src: image, className: "common-button_image", alt: alt })) : (image))),
        label));
};
...
var AnswerButton = function (_a) {
    ...
    return (React.createElement("button", { "data-testid": "answer-button", className: cn("correct-button", className, (_b = {},
...
var SwitchButton = function (_a) {
    ...
    return (React.createElement("label", { "data-testid": "switch-button", className: cn("switch", className) },
...
var CircleProgressBar = function (_a) {
    ...
    return (React.createElement("div", { "data-testid": "circle-progress-bar", className: cn("bar-wrapper", className) },
...
var VisualUploadFile = function (_a) {
    ...
    return (React.createElement("div", { className: cn("load-file", (_b = {}, _b["uploaded-file-container"] = selectedImage, _b), containerClassName) },
        ...
        !selectedImage && (React.createElement("div", { className: cn("load-file__content-wrapper", contentClassName) },
            React.createElement("img", { src: img$I, alt: "download", className: "load-file__img" }),
            React.createElement("label", { htmlFor: "load-file", className: cn("load-file__label", labelClassName) }, title),
