...
var SelectInput = function (_a) {
    ...
    return (jsxRuntime.jsx(Select, { options: options, className: cn("select-container", className), classNamePrefix: "select", placeholder: placeholder, name: name, onChange: onChange, onBlur: onBlur, styles: styles, menuPortalTarget: modalPortalTarget }));
};
...
var Navigation = function (_a) {
    ...
    return (jsxRuntime.jsx("div", __assign({ className: cn("navigation", className) }, { children: jsxRuntime.jsx("nav", __assign({ className: "navigation__tabs-wrapper", role: "navigation" }, { children: jsxRuntime.jsx("menu", __assign({ className: "navigation__tabs" }, { children: navLinks.map(function (_a) {
                    ...
                    return anchor ? (jsxRuntime.jsx("a", __assign({ href: to, className: linkStyles(to, false, true, customStyles) }, { children: customContent || text }))) : (jsxRuntime.jsx(reactRouterDom.NavLink, __assign({ to: to, className: function (_a) {
...
var Checkbox = function (_a) {
    ...
    return (jsxRuntime.jsxs("label", __assign({ className: cn("checkbox", className, (_b = {},
            ...
            _b)) }, { children: [jsxRuntime.jsx(formik.Field, { type: "checkbox", name: name, className: "checkbox__input" }), jsxRuntime.jsx("span", { className: "checkbox__indicator" }), jsxRuntime.jsx("div", __assign({ className: "checkbox__info" }, { children: jsxRuntime.jsx("span", __assign({ className: "checkbox__info-title" }, { children: title })) })), errors && touched && (jsxRuntime.jsx(formik.ErrorMessage, { name: name, component: errComponent || "div", className: cn("checkbox-warning", errClassName) }))] })));
};
...
var Dialog = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b, title = _a.title, _c = _a.acceptLabel, acceptLabel = _c === void 0 ? "Скасувати" : _c, _d = _a.declineLabel, declineLabel = _d === void 0 ? "Зберегти" : _d, onAccept = _a.onAccept, onDecline = _a.onDecline, child = _a.child, isOpen = _a.isOpen, afterOpen = _a.afterOpen;
    var customStyles = {
        content: {
            top: "50%",
            left: "50%",
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsx(Modal, __assign({ isOpen: isOpen, onAfterOpen: afterOpen, onRequestClose: onDecline, style: customStyles, contentLabel: "Example Modal", closeTimeoutMS: 300 }, { children: jsxRuntime.jsx("div", __assign({ "data-testid": "dialog", className: cn("wrapper", className) }, { children: jsxRuntime.jsxs("div", __assign({ className: "content" }, { children: [jsxRuntime.jsx(Title, { children: title, size: 24, className: "title" }), jsxRuntime.jsx("button", __assign({ onClick: onDecline, className: "close" }, { children: jsxRuntime.jsx(Close, {}) })), child, jsxRuntime.jsxs("div", __assign({ className: "decision-buttons" }, { children: [jsxRuntime.jsx(CommonButton, { onClick: onDecline, label: acceptLabel, outlined: true }), jsxRuntime.jsx(CommonButton, { onClick: onAccept, label: declineLabel })] }))] })) })) })) }));
};
