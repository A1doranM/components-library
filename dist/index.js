...
var Reminder = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: cn("notification", (_b = {}, _b["warning"] = warning, _b), className) }, { children: [jsxRuntime.jsx("img", { src: img$O, alt: "notification icon", className: "notification-icon" }), jsxRuntime.jsx("h4", { children: text }), withButton && (jsxRuntime.jsx("button", __assign({ className: "notification_close-btn" }, { children: jsxRuntime.jsx("img", { src: img$P, alt: "close" }) })))] })));
};
        ...
        switch (type) {
            case "password":
                return (jsxRuntime.jsxs("div", __assign({ className: cn("form-field-wrapper", "password-input", className) }, { children: [jsxRuntime.jsx(formik.Field, { type: this.state.show ? "password" : "text", name: name, placeholder: " ", className: cn("form-field", {
                            ...
                            }, className), onBlur: onBlur, "data-testid": "input" }), jsxRuntime.jsx("img", { src: !this.state.show ? img$N : img$M, alt: "eye", className: "password-input__eye", onClick: handleEyeClick }), jsxRuntime.jsx("label", __assign({ className: "form-field-label", htmlFor: name }, { children: placeholder })), errors && touched && (jsxRuntime.jsx(formik.ErrorMessage, { name: name, component: errComponent || "div", className: cn("form-field-error-message", errClassName) }))] })));
            default:
...
var AnswerButton = function (_a) {
    ...
    return (jsxRuntime.jsxs("button", __assign({ "data-testid": "answer-button", className: cn("correct-button", className, (_b = {},
            ...
            _b)), onClick: onClick }, { children: [jsxRuntime.jsx("div", __assign({ className: "correct-button_image-container" }, { children: jsxRuntime.jsx("img", { src: cancel
                        ? !hold
                            ? img$P
                            : img$J
                        : !hold
