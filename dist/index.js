...
var ArrowRightIcon = require('assets/images/icons/arrow.svg');
var ArrowLeftIcon = require('assets/images/icons/arrow-reversed.svg');
...
function Items(_a) {
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: currentItems &&
            currentItems.map(function (item) { return (jsxRuntime.jsx("div", __assign({ className: "item-container" }, { children: item.element }))); }) }));
}
