...
function Items(_a) {
    ...
    return (jsx$1(Fragment$1, { children: currentItems &&
            currentItems.map(function (item) { return (jsx$1("div", __assign({ className: "item-container" }, { children: item.element }))); }) }));
}
