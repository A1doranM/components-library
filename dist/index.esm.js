...
import React__default, { useState as useState$1, useCallback, useLayoutEffect as useLayoutEffect$1, createContext, forwardRef, useContext, createElement, Fragment, useRef, useMemo, Component, useEffect as useEffect$1, Children, useReducer, useImperativeHandle } from 'react';
...
var Title = function (_a) {
    ...
    return (React__default.createElement("h4", { className: cn("title", className, "title_size_".concat(size), "title_weight_".concat(weight)), "data-testid": "title" }, children));
};
...
var Expand = function (_a) {
    var _b, _c, _d, _e;
    var children = _a.children, title = _a.title, _f = _a.open, open = _f === void 0 ? false : _f, _g = _a.isLast, isLast = _g === void 0 ? false : _g, titleClassName = _a.titleClassName, _h = _a.isStatic, isStatic = _h === void 0 ? false : _h;
    var _j = useState$1(open), isOpen = _j[0], setOpen = _j[1];
    ...
    return (React__default.createElement("section", { className: cn("expand", (_b = {},
        ...
        React__default.createElement("h2", { className: cn("expand__header", (_c = {},
                ...
                _c), (_d = {}, _d["expand_static"] = isStatic, _d), titleClassName), onClick: handleToggle }, title),
        React__default.createElement("div", { className: cn("expand__content", (_e = {},
...
var Status = function (_a) {
    ...
    return (React__default.createElement("h3", { className: cn("status", className, (_b = {},
...
function useStateManager(_ref) {
  ...
  var _useState = useState$1(propsInputValue !== undefined ? propsInputValue : defaultInputValue),
    _useState2 = _slicedToArray$2(_useState, 2),
    stateInputValue = _useState2[0],
    setStateInputValue = _useState2[1];
  var _useState3 = useState$1(propsMenuIsOpen !== undefined ? propsMenuIsOpen : defaultMenuIsOpen),
    _useState4 = _slicedToArray$2(_useState3, 2),
    stateMenuIsOpen = _useState4[0],
    setStateMenuIsOpen = _useState4[1];
  var _useState5 = useState$1(propsValue !== undefined ? propsValue : defaultValue),
...
var jsx = function jsx(type, props) {
  ...
  if (props == null || !hasOwnProperty$a.call(props, 'css')) {
    // $FlowFixMe
...
function n(t){return t&&t.document&&t.location&&t.alert&&t.setInterval}function o(t){if(null==t)return window;if(!n(t)){const e=t.ownerDocument;return e&&e.defaultView||window}return t}function i$1(t){return o(t).getComputedStyle(t)}function r(t){return n(t)?"":t?(t.nodeName||"").toLowerCase():""}function l(){const t=navigator.userAgentData;return null!=t&&t.brands?t.brands.map((t=>t.brand+"/"+t.version)).join(" "):navigator.userAgent}function c(t){return t instanceof o(t).HTMLElement}function s(t){return t instanceof o(t).Element}function f(t){if("undefined"==typeof ShadowRoot)return !1;return t instanceof o(t).ShadowRoot||t instanceof ShadowRoot}function u(t){const{overflow:e,overflowX:n,overflowY:o,display:r}=i$1(t);return /auto|scroll|overlay|hidden/.test(e+o+n)&&!["inline","contents"].includes(r)}function h(){return !/^((?!chrome|android).)*safari/i.test(l())}function g(t){return ["html","body","#document"].includes(r(t))}const w$1=Math.round;function v(t,e,n){var i,r,l,f;void 0===e&&(e=!1),void 0===n&&(n=!1);const u=t.getBoundingClientRect();let d=1,a=1;e&&c(t)&&(d=t.offsetWidth>0&&w$1(u.width)/t.offsetWidth||1,a=t.offsetHeight>0&&w$1(u.height)/t.offsetHeight||1);const g=s(t)?o(t):window,m=!h()&&n,p=(u.left+(m&&null!=(i=null==(r=g.visualViewport)?void 0:r.offsetLeft)?i:0))/d,v=(u.top+(m&&null!=(l=null==(f=g.visualViewport)?void 0:f.offsetTop)?l:0))/a,y=u.width/d,x=u.height/a;return {width:y,height:x,top:v,right:p+y,bottom:v+x,left:p,x:p,y:v}}function y(t){return (e=t,(e instanceof o(e).Node?t.ownerDocument:t.document)||window.document).documentElement;var e;}function E(t){if("html"===r(t))return t;const e=t.assignedSlot||t.parentNode||(f(t)?t.host:null)||y(t);return f(e)?e.host:e}function H(t){const e=E(t);return g(e)?t.ownerDocument.body:c(e)&&u(e)?e:H(e)}function C(t,e){var n;void 0===e&&(e=[]);const i=H(t),r=i===(null==(n=t.ownerDocument)?void 0:n.body),l=o(i),c=r?[l].concat(l.visualViewport||[],u(i)?i:[]):i,s=e.concat(c);return r?s:s.concat(C(c))}function z(t,e,n,o){void 0===o&&(o={});const{ancestorScroll:i=!0,ancestorResize:r=!0,elementResize:l=!0,animationFrame:c=!1}=o,f=i&&!c,u=f||r?[...s(t)?C(t):t.contextElement?C(t.contextElement):[],...C(e)]:[];u.forEach((t=>{f&&t.addEventListener("scroll",n,{passive:!0}),r&&t.addEventListener("resize",n);}));let d,a=null;if(l){let o=!0;a=new ResizeObserver((()=>{o||n(),o=!1;})),s(t)&&!c&&a.observe(t),s(t)||!t.contextElement||c||a.observe(t.contextElement),a.observe(e);}let h=c?v(t):null;return c&&function e(){const o=v(t);!h||o.x===h.x&&o.y===h.y&&o.width===h.width&&o.height===h.height||n();h=o,d=requestAnimationFrame(e);}(),n(),()=>{var t;u.forEach((t=>{f&&t.removeEventListener("scroll",n),r&&t.removeEventListener("resize",n);})),null==(t=a)||t.disconnect(),a=null,c&&cancelAnimationFrame(d);}}

var index =  useLayoutEffect$1 ;
...
var MenuPlacer = function MenuPlacer(props) {
  ...
  var ref = useRef(null);
  var _useState = useState$1(maxMenuHeight),
    _useState2 = _slicedToArray$2(_useState, 2),
...
var MenuPortal = function MenuPortal(_ref8) {
  ...
  var _useState5 = useState$1(coercePlacement(menuPlacement)),
    _useState6 = _slicedToArray$2(_useState5, 2),
...
var StateManagedSelect = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  return /*#__PURE__*/React.createElement(Select$1, _extends$3({
    ref: ref
  }, baseSelectProps));
});
...
var SelectInput = function (_a) {
    ...
    return (React__default.createElement(Select, { options: options, className: cn("select-container", className), classNamePrefix: "select", placeholder: placeholder, name: name, onChange: onChange, onBlur: onBlur, styles: styles, menuPortalTarget: document.body }));
};
...
const Form$1 = /*#__PURE__*/React.forwardRef((props, ref) => {
...
var Navigation = function (_a) {
    ...
    return (React__default.createElement("div", { className: cn("navigation", className) },
        React__default.createElement("nav", { className: "navigation__tabs-wrapper", role: "navigation" },
            React__default.createElement("menu", { className: "navigation__tabs" }, navLinks.map(function (_a) {
                var to = _a.to, text = _a.text, customContent = _a.customContent, customStyles = _a.customStyles;
                return (React__default.createElement(NavLink, { to: to, key: to, className: function (_a) {
...
var Reminder = function (_a) {
    ...
    return (React__default.createElement("div", { className: cn("notification", className) },
        React__default.createElement("img", { src: img$O, alt: "notification icon", className: "notification-icon" }),
        React__default.createElement("h4", null, text),
        withButton && (React__default.createElement("button", { className: "notification_close-btn" },
            React__default.createElement("img", { src: img$P, alt: "close" })))));
};
...
var FormField = function (_a) {
    ...
    var _f = useState$1(false), shown = _f[0], setShown = _f[1];
    ...
    switch (type) {
        case "password":
            return (React__default.createElement("div", { className: cn("form-field-wrapper", "password-input", className), "data-testid": "input" },
                React__default.createElement(Field, { type: shown ? "password" : "text", name: name, placeholder: " ", className: cn("form-field", {
                        "form-field_error": errors && touched && errors[name] && touched[name]
                    }, className), onBlur: onBlur }),
                React__default.createElement("img", { src: !shown ? img$N : img$M, alt: "eye", className: "password-input__eye", onClick: handleEyeClick }),
                React__default.createElement("label", { className: "form-field-label", htmlFor: name }, placeholder),
                React__default.createElement(ErrorMessage, { name: name, component: errComponent || "div", className: cn("form-field-error-message", errClassName) })));
        default:
...
var RadioButton = function (_a) {
    ...
    return (React__default.createElement("label", { className: cn("radio-btn", className, (_b = {},
            _b["radio-btn_active"] = checked,
            _b["radio-btn_disabled"] = disabled,
            _b)), onClick: onClick },
        React__default.createElement("input", { className: "radio-btn__input", type: "radio", name: name, value: value, checked: checked, disabled: disabled, onChange: function () { } }),
        React__default.createElement("span", { className: "radio-btn__indicator" }),
        React__default.createElement("div", { className: "radio-btn__info" },
            title && React__default.createElement("p", { className: "radio-btn__info-title" }, title),
            body && React__default.createElement("p", { className: "radio-btn__info-body" }, body),
            footer && React__default.createElement("p", { className: "radio-btn__info-footer" }, footer),
            warning && (React__default.createElement("p", { className: "radio-btn__info-warning" }, warning)))));
};
...
var CommonButton = function (_a) {
    ...
    return (React__default.createElement("button", { className: cn("common-button", className, (_b = {},
        ...
        (image || round) && (React__default.createElement("div", { className: "common-button_image-container" },
            React__default.createElement("img", { src: image, className: "common-button_image", alt: "button icon" }))),
        !round && label));
};
...
var AnswerButton = function (_a) {
    ...
    return (React__default.createElement("button", { className: cn("correct-button", className, (_b = {},
            ...
            _b)), onClick: onClick },
        React__default.createElement("div", { className: "correct-button_image-container" },
            React__default.createElement("img", { src: cancel
                    ? !hold
                        ? img$P
                        : img$J
                    : !hold
...
var CircleProgressBar = function (_a) {
    ...
    var _b = useState$1(0), percent = _b[0], setPercent = _b[1];
    ...
    return (React__default.createElement("div", { className: cn("bar-wrapper", className) },
        React__default.createElement("div", { className: "circle-progress-bar", "data-pct": progress },
            React__default.createElement("svg", { className: "circle-progress-bar__svg", width: "60", height: "60" },
                ...
                React__default.createElement("circle", { className: "circle-progress-bar__bar", r: RADIUS, cx: "30", cy: "30", fill: "transparent", strokeDasharray: DASHES, strokeDashoffset: percent })))));
};
...
var SimpleUploadFile = function (_a) {
    ...
    var files = acceptedFiles.map(function (file) { return (React__default.createElement("li", { key: file.path },
        file.path,
        " - ",
        file.size,
        " bytes")); });
    return (React__default.createElement("div", __assign({}, getRootProps({ className: "dropzone" }), { className: cn("simple-file-loader", files.length && "simple-file-loader_uploaded", className) }),
        React__default.createElement("h4", { className: "simple-file-loader__title" }, files.length
        ...
        React__default.createElement("h4", { className: "simple-file-loader__formats" }, files.length
...
var VisualUploadFile = function (_a) {
    ...
    var _c = useState$1(null), selectedImage = _c[0], setSelectedImage = _c[1];
...
var Id = function (_a) {
    ...
    return React__default.createElement("img", { src: img$H, alt: "id", className: className });
};
...
var Add = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$G, alt: "add", className: className });
};
...
var Grn = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$F, alt: "UAH", className: className });
};
...
var Copy = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$E, alt: "copy", className: className });
};
...
var Mail = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$D, alt: "mail", className: className });
};
...
var Help = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$C, alt: "help", className: className });
};
...
var Lock = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$B, alt: "lock", className: className });
};
...
var Plus = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$A, alt: "plus", className: className });
};
...
var Swap = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$z, alt: "swap", className: className });
};
...
var Alert = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$y, alt: "alert", className: className });
};
...
var Clock = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$x, alt: "clock", className: className });
};
...
var Close = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$w, alt: "close", className: className });
};
...
var Enter = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$v, alt: "enter", className: className });
};
...
var Plane = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$u, alt: "plane", className: className });
};
...
var Print = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$t, alt: "print", className: className });
};
...
var Pencil = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$s, alt: "pencil", className: className });
};
...
var Person = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$r, alt: "person", className: className });
};
...
var Cancel = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$q, alt: "cancel", className: className });
};
...
var Google = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$p, alt: "google", className: className });
};
...
var Upload = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$o, alt: "upload", className: className });
};
...
var Reload = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$n, alt: "reload", className: className });
};
...
var Remove = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$m, alt: "remove", className: className });
};
...
var Search = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$l, alt: "search", className: className });
};
...
var GrayEye = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$k, alt: "gray eye", className: className });
};
...
var Facebook = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$j, alt: "facebook", className: className });
};
...
var BlackEye = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$i, alt: "black eye", className: className });
};
...
var Calendar = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$h, alt: "calendar", className: className });
};
...
var Document = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$g, alt: "document", className: className });
};
...
var Download = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$f, alt: "download", className: className });
};
...
var Location = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$e, alt: "location", className: className });
};
...
var AddCircle = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$d, alt: "add circle", className: className });
};
...
var Checkmark = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$c, alt: "checkmark", className: className });
};
...
var LongArrow = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$b, alt: "long arrow", className: className });
};
...
var ShortArrow = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$a, alt: "short arrow", className: className });
};
...
var DoubleArrow = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$9, alt: "double arrow", className: className });
};
...
var FilledHeart = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return React__default.createElement("img", { src: img$8, alt: "filled heart", className: className });
};
...
var SettingsGray = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return (React__default.createElement("img", { src: img$7, alt: "settings gray", className: className }));
};
...
var TrashDefault = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return (React__default.createElement("img", { src: img$6, alt: "trash default", className: className }));
};
...
var OutlinedHeart = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return (React__default.createElement("img", { src: img$5, alt: "outlined heart", className: className }));
};
...
var TrashOutlined = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return (React__default.createElement("img", { src: img$4, alt: "trash outlined", className: className }));
};
...
var SettingsBlack = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return (React__default.createElement("img", { src: img$3, alt: "settings black", className: className }));
};
...
var GrayDisabledEye = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return (React__default.createElement("img", { src: img$2, alt: "gray disabled eye", className: className }));
};
...
var ShortFilledArrow = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return (React__default.createElement("img", { src: img$1, alt: "short filled arrow", className: className }));
};
...
var CancelCertificate = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b;
    return (React__default.createElement("img", { src: img, alt: "cancel certificate", className: className }));
};

export { AddCircle as AddCircleIcon, Add as AddIcon, Alert as AlertIcon, AnswerButton, BlackEye as BlackEyeIcon, Calendar as CalendarIcon, CancelCertificate as CancelCertificateIcon, Cancel as CancelIcon, Checkmark as CheckmarkIcon, CircleProgressBar, Clock as ClockIcon, Close as CloseIcon, CommonButton, Copy as CopyIcon, Document as DocumentIcon, DoubleArrow as DoubleArrowIcon, Download as DownloadIcon, Enter as EnterIcon, Expand, Facebook as FacebookIcon, FilledHeart as FilledHeartIcon, FormField, Google as GoogleIcon, GrayDisabledEye as GrayDisableEyeIcon, GrayEye as GrayEyeIcon, Grn as GrnIcon, Help as HelpIcon, Location as LocationIcon, Lock as LockIcon, LongArrow as LongArrowIcon, Mail as MailIcon, Navigation, Reminder as Notification, OutlinedHeart as OutlinedHeartIcon, Pencil as PencilIcon, Person as PersonIcon, Plane as PlaneIcon, Plus as PlusIcon, Print as PrintIcon, RadioButton, Reload as ReloadIcon, Remove as RemoveIcon, Search as SearchIcon, SelectInput as Select, SettingsBlack as SettingsBlackIcon, SettingsGray as SettingsGrayIcon, ShortArrow as ShortArrowIcon, ShortFilledArrow as ShortFilledArrowIcon, SimpleUploadFile, Status, Swap as SwapIcon, SwitchButton, Title, TrashDefault as TrashDefaultIcon, TrashOutlined as TrashOutlinedIcon, Upload as UploadIcon, VisualUploadFile, Id as idIcon };
