...
var SelectInput = function (_a) {
    ...
    return (jsx$1(Select, { options: options, className: cn("select-container", className), classNamePrefix: "select", placeholder: placeholder, name: name, onChange: onChange, onBlur: onBlur, styles: styles, menuPortalTarget: modalPortalTarget, menuIsOpen: true }));
};
