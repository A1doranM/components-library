...
var SelectInput = function (_a) {
    ...
    return (React__default.createElement(Select, { options: options, className: cn("select-container", className), classNamePrefix: "select", placeholder: placeholder, name: name, onChange: onChange, onBlur: onBlur, styles: styles, menuPortalTarget: modalPortalTarget }));
};
    ...
    return (React__default.createElement("div", { className: cn("navigation", className) },
        React__default.createElement("nav", { className: "navigation__tabs-wrapper", role: "navigation" },
            React__default.createElement("menu", { className: "navigation__tabs" }, navLinks.map(function (_a) {
                ...
                return anchor ? (React__default.createElement("a", { href: to, className: linkStyles(to, false, true, customStyles) }, customContent || text)) : (React__default.createElement(NavLink, { to: to, key: to, className: function (_a) {
...
var Checkbox = function (_a) {
    ...
    return (React__default.createElement("label", { className: cn("checkbox", className, (_b = {},
        ...
        errors && touched && (React__default.createElement(ErrorMessage, { name: name, component: errComponent || "div", className: cn("checkbox-warning", errClassName) }))));
};
