...
var SelectInput = function (_a) {
    ...
    return (jsxs("div", __assign({ className: "select-wrapper" }, { children: [jsx$1(Select, { options: options, className: cn("select-container", className), classNamePrefix: "select", placeholder: placeholder, name: name, onChange: handleChange, onBlur: handleBlur, onFocus: handleFocus, styles: styles, menuPortalTarget: modalPortalTarget, defaultMenuIsOpen: true }), jsx$1("p", __assign({ className: cn("select-wrapper__placeholder", {
...
var Reminder = function (_a) {
    ...
    return (jsxs("div", __assign({ className: cn("notification", (_b = {}, _b["warning"] = warning, _b), className) }, { children: [jsx$1("img", { src: img$L, alt: "notification icon", className: "notification-icon" }), jsx$1("h4", { children: text }), withButton && (jsx$1("button", __assign({ className: "notification_close-btn" }, { children: jsx$1("img", { src: img$M, alt: "close" }) })))] })));
};
        ...
        switch (type) {
            case "password":
                return (jsxs("div", __assign({ className: cn("form-field-wrapper", "password-input", className) }, { children: [jsx$1(Field, { type: this.state.show ? "password" : "text", name: name, placeholder: " ", className: cn("form-field", {
                            ...
                            }, className), onBlur: onBlur, "data-testid": "input" }), jsx$1("img", { src: !this.state.show ? img$K : img$J, alt: "eye", className: "password-input__eye", onClick: handleEyeClick }), jsx$1("label", __assign({ className: "form-field-label", htmlFor: name }, { children: placeholder })), errors && touched && (jsx$1(ErrorMessage, { name: name, component: errComponent || "div", className: cn("form-field-error-message", errClassName) }))] })));
            default:
...
var AnswerButton = function (_a) {
    ...
    return (jsxs("button", __assign({ "data-testid": "answer-button", className: cn("correct-button", className, (_b = {},
            ...
            _b)), onClick: onClick }, { children: [jsx$1("div", { className: "correct-button_image-container" }), jsx$1("span", { children: !round && label })] })));
};
...
var VisualUploadFile = function (_a) {
    ...
    return (jsxs("div", __assign({ className: cn("load-file", (_b = {}, _b["uploaded-file-container"] = selectedImage, _b), containerClassName) }, { children: [selectedImage && (jsx$1("div", __assign({ className: "upload-container" }, { children: jsx$1("img", { alt: "not fount", src: URL.createObjectURL(selectedImage), className: "uploaded-img" }) }))), jsx$1("input", { id: "load-file", type: "file", className: "load-file__input", onChange: function (event) {
                    var _a, _b;
